...
const services: Service[] = [
  {
    ...
    icon: <Brain className="w-7 h-7 md:w-8 md:h-8" aria-hidden="true" />,
  ...
  },
  {
    ...
    icon: <Bot className="w-7 h-7 md:w-8 md:h-8" aria-hidden="true" />,
  ...
  },
  {
    ...
    icon: <Cloud className="w-7 h-7 md:w-8 md:h-8" aria-hidden="true" />,
  ...
  },
  {
    ...
    icon: <Shield className="w-7 h-7 md:w-8 md:h-8" aria-hidden="true" />,
  ...
  },
  {
    ...
    icon: <BarChart3 className="w-7 h-7 md:w-8 md:h-8" aria-hidden="true" />,
  ...
  },
  {
    ...
    icon: <Rocket className="w-7 h-7 md:w-8 md:h-8" aria-hidden="true" />,
  ...
  },
  {
    ...
    icon: <Briefcase className="w-7 h-7 md:w-8 md:h-8" aria-hidden="true" />,
  ...
  },
  {
    ...
    icon: <Wifi className="w-7 h-7 md:w-8 md:h-8" aria-hidden="true" />,
  ...
  },
  {
    ...
    icon: <GraduationCap className="w-7 h-7 md:w-8 md:h-8" aria-hidden="true" />,
...
const ImagePlaceholder = ({ className = '' }: { className?: string }) => (
  <div className={`bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center ${className}`}>
    <div className="w-16 h-16 rounded-full bg-slate-700/50 flex items-center justify-center">
      <Sparkles className="w-8 h-8 text-slate-600" aria-hidden="true" />
    </div>
  </div>
);
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
              ...
              <div className="hidden lg:flex items-center space-x-6 xl:space-x-8">
                {navItems.map((item) => (
                  <Link 
                    key={item.label}
                    href={item.href} 
                    className="text-gray-300 hover:text-white transition-colors text-sm xl:text-base focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-black rounded px-2 py-1"
                ...
                <Link 
                  href="/roi-calculator" 
                  className="bg-gradient-to-r from-purple-600 to-blue-600 px-4 py-2 rounded-lg text-white font-semibold hover:shadow-lg hover:shadow-purple-500/25 transition-all text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-black"
                >
                  Calculate ROI
                </Link>
              </div>
              ...
              >
                {navItems.map((item) => (
                  <Link
                    key={item.label}
                    href={item.href}
                    className="block py-3 text-gray-300 hover:text-white transition-colors min-h-[44px] flex items-center focus:outline-none focus:ring-2 focus:ring-purple-500 rounded"
                ...
                <Link 
                  href="/roi-calculator" 
                  className="block mt-4 bg-gradient-to-r from-purple-600 to-blue-600 px-4 py-3 rounded-lg text-white font-semibold text-center min-h-[44px] focus:outline-none focus:ring-2 focus:ring-purple-500"
                  onClick={() => setIsMenuOpen(false)}
                  role="menuitem"
                >
                  Calculate ROI
      ...
      <main id="main-content" role="main">
        ...
        >
          {/* Background Effects */}
          <div className="absolute inset-0 bg-gradient-to-br from-purple-900/20 via-black to-blue-900/20" aria-hidden="true" />
          ...
          <div className="container mx-auto px-4 relative z-10 py-12 md:py-0">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                <Link 
                  href="/services" 
                  className="btn btn-primary px-6 md:px-8 py-3 md:py-4 text-base md:text-lg min-h-[48px] inline-flex items-center justify-center"
                >
                  Explore Services
                </Link>
                <Link 
                  href="/contact" 
                  className="btn btn-secondary px-6 md:px-8 py-3 md:py-4 text-base md:text-lg min-h-[48px] inline-flex items-center justify-center"
                >
              ...
              <button 
                className="hidden md:inline-flex items-center gap-2 text-gray-400 hover:text-white transition-colors mb-12 focus:outline-none focus:ring-2 focus:ring-purple-500 rounded-lg p-2"
                aria-label="Watch introduction video about OMNIVERITY"
                type="button"
              >
                <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                  <Play className="w-5 h-5 text-white ml-1" aria-hidden="true" />
                </div>
              ...
              {/* Quick Stats */}
              <div 
                className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 animate-fade-in-up" 
        ...
        >
          <div className="container mx-auto px-4">
            <div className="text-center mb-10 md:mb-12">
              <h2 id="services-heading" className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Our Services</h2>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              {services.map((service) => (
                <Link
                  key={service.id}
                  href={service.link}
                  className="group relative bg-gray-900 rounded-xl overflow-hidden hover:bg-gray-800 transition-all duration-300 border border-gray-800 hover:border-gray-600 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-black"
                ...
                >
                  ...
                  <div className="p-4 md:p-6">
                    ...
                    <ul className="space-y-1 mb-4" aria-label={`${service.title} features`}>
            ...
            <div className="text-center mt-10 md:mt-12">
              <Link 
                href="/services" 
                className="inline-flex items-center space-x-2 btn btn-primary px-6 py-3 min-h-[48px]"
              >
        ...
        {/* Industries Section */}
        <section 
          className="py-16 md:py-20 bg-gray-900/50"
          aria-labelledby="industries-heading"
        >
          <div className="container mx-auto px-4">
            <div className="text-center mb-10 md:mb-12">
              <h2 id="industries-heading" className="text-3xl md:text-4xl font-bold mb-4">Industries We Serve</h2>
              <p className="text-lg md:text-xl text-gray-400">Specialized solutions for every sector</p>
            </div>

            <ul className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6" role="list">
        ...
        >
          <div className="container mx-auto px-4">
            <div className="text-center mb-10 md:mb-12">
              <h2 id="why-choose-heading" className="text-3xl md:text-4xl font-bold mb-4">Why Choose OMNIVERITY?</h2>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
              {[
                {
                  icon: <Award className="w-10 h-10 md:w-12 md:h-12" aria-hidden="true" />,
                  title: 'Industry Leaders',
                  desc: '20+ years of expertise in enterprise technology'
                },
                {
                  icon: <Users className="w-10 h-10 md:w-12 md:h-12" aria-hidden="true" />,
                  title: 'Expert Team',
                  desc: '100+ certified professionals worldwide'
                },
                {
                  icon: <TrendingUp className="w-10 h-10 md:w-12 md:h-12" aria-hidden="true" />,
                  title: 'Proven Results',
                  desc: '95% client satisfaction and retention rate'
                },
                {
                  icon: <Clock className="w-10 h-10 md:w-12 md:h-12" aria-hidden="true" />,
                  title: '24/7 Support',
        ...
        {/* Products Preview */}
        <section 
          className="py-16 md:py-20 bg-gradient-to-br from-purple-900/20 to-blue-900/20"
          aria-labelledby="products-heading"
        >
          <div className="container mx-auto px-4">
            <div className="text-center mb-10 md:mb-12">
              <h2 id="products-heading" className="text-3xl md:text-4xl font-bold mb-4">Our Products</h2>
            ...
            <div className="text-center mt-8">
              <Link 
                href="/products" 
                className="inline-flex items-center space-x-2 text-purple-400 hover:text-purple-300 transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 rounded p-2"
              >
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link 
                  href="/contact" 
                  className="btn btn-primary px-6 md:px-8 py-3 md:py-4 min-h-[48px] inline-flex items-center justify-center"
                >
                  Get Started Today
                </Link>
                <Link 
                  href="/roi-calculator" 
                  className="btn btn-secondary px-6 md:px-8 py-3 md:py-4 min-h-[48px] inline-flex items-center justify-center"
                >
                  Calculate Your ROI
                </Link>
              </div>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Logo & Description */}
            <div>
              <Link href="/" className="flex items-center space-x-2 mb-4" aria-label="OMNIVERITY - Go to homepage">
              ...
              <div className="flex space-x-4">
                <a 
                  href="https://linkedin.com/company/omniverity" 
                  aria-label="Follow OMNIVERITY on LinkedIn" 
                  className="text-gray-400 hover:text-white transition-colors p-2 focus:outline-none focus:ring-2 focus:ring-purple-500 rounded"
                  target="_blank"
                ...
                <a 
                  href="https://twitter.com/omniverity" 
                  aria-label="Follow OMNIVERITY on Twitter" 
                  className="text-gray-400 hover:text-white transition-colors p-2 focus:outline-none focus:ring-2 focus:ring-purple-500 rounded"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <ul className="space-y-2">
                {services.slice(0, 5).map(service => (
                  <li key={service.id}>
                    <Link 
                      href={service.link} 
                      className="text-gray-400 hover:text-white text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 rounded"
                    >
                      {service.title}
                    </Link>
                  </li>
            ...
            <div>
              ...
              <address className="not-italic">
                <ul className="space-y-3">
                  <li>
                    <a 
                      href="mailto:info@omniverity.com" 
                      className="flex items-center gap-2 text-gray-400 hover:text-white text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 rounded"
                    >
              ...
              <Link 
                href="/contact" 
                className="inline-block mt-4 bg-purple-600 px-4 py-2 rounded text-sm font-semibold hover:bg-purple-700 transition-colors min-h-[44px] flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-black"
              >
                Get In Touch
              </Link>
            </div>
            ...
            <nav aria-label="Legal navigation">
              <ul className="flex gap-4">
                <li>
                  <Link 
                    href="/privacy-policy" 
                    className="hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 rounded"
                  >
                    Privacy Policy
                  </Link>
                </li>
